...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ] || [ -z "$4" ]; then
    ...
    echo " "
    echo "  usage: $0 <original-git-remote> <dir-to-isolate> <new-repo-name> <new-remote-origin-location> [<branch-name>]"
    echo "    <branch-name> : branch for checkout and pull. Default to master"
